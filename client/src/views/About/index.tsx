        ...
        <article className={styles.about}>
          <Fade>
            ...
            <p>
              ...
              <span>Jason Smith</span>, I am a <span>Frontend Engineer</span> living in{' '}
              <span>Denver, CO</span>. I am a builder and a creative. Whether I am building with hammer and
              nail or with a keystroke, my objective is to create products that last. During my 13 years of
              software experience building web applications, I have acquired a track record of turning complex
              business needs into innovative, user-centric software.
            </p>
          </Fade>
          <Fade>
            <p>
          ...
          <Fade>
            <p>
              This site serves as a side project to foster continuous improvement as well as a portfolio. I
              try to keep it updated with new skills and technologies as I learn them. Featuring functional{' '}
              <code>React</code> components, <code>MobX</code> for state management along with{' '}
              <code>NodeJs</code> and <code>Firebase</code>{' '}
              <span className={`${styles['about__icon-fire']} --flickering`}>🔥</span> on the backend. The
              graphics are original and 10 years old. The layout uses a mobile first approach and is{' '}
              <code>responsive</code> across all devices.
            </p>
          </Fade>
          <Fade>
            <p>
              ...
              technologies used on this site include: <code>React Query</code>, <code>React Router</code>,{' '}
